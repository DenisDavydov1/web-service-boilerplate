    ...
    private static async Task HandleExceptionAsync(HttpContext context, Exception exception)
    {
        ...
        switch (exception)
        {
            ...
            case ArgumentException ex:
                ...
                details.Title = "One or more validation errors occurred.";
                details.Status = (int)HttpStatusCode.BadRequest;
                details.Errors.Add(ex.ParamName.ToCamelCase() ?? "Validation Error", new[] {ex.Message});
                break;
            case BusinessException ex:
                ...
                {
                    ex.ParameterNames.ToList().ForEach(p => details.Errors.Add(p.ToCamelCase(), new[] {ex.Message}));
                }
                else
                {
                    details.Errors.Add("Validation Error", new[] {ex.Message});
                }
                break;
            ...
            case AuthenticationException ex:
                ...
                details.Errors.Add("Authentication Error", new[] {ex.Message});
                break;
            ...
            case EntityNotFoundException ex:
                ...
                details.Errors.Add(ex.ParamName.ToCamelCase() ?? "Entity Not Found Error", new[] {ex.Message});
                break;
            ...
            case ConflictException ex:
                ...
                details.Errors.Add("Conflict Error", new[] {ex.Message});
                break;
            ...
            case DbUpdateException ex:
                ...
                details.Errors.Add("Unprocessable Entity", new[] { ex.Message });
                break;
